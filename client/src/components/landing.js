...
const Landing = props => {
    ...
    return (
        ...
        <motion.div className="landing" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} >
            <h1 className="title" style={{fontStyle: 'italic', fontFamily: 'fantasy'}} >Tic-Tac-Toe-Cool</h1>
            
                <Button className="session-btn" color="primary" size="md" style={{fontFamily: 'monospace',  width: '300px'}} onClick={create_toggle} >Create Session</Button>
                ...
                <Button className="session-btn" color="primary" style={{fontFamily: 'monospace', width: '300px'}} size="sm" onClick={join_toggle}>Join Session</Button>
